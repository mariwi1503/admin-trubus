...
export const dummyProducts: Product[] = [
  { id: '1', name: 'Benih Padi Ciherang Super', category: 'Benih', price: 85000, stock: 150, sold: 234, status: 'active', image: 'https://images.unsplash.com/photo-1536304993881-ff6e9eefa2a6?w=400&h=300&fit=crop', description: 'Benih padi varietas Ciherang dengan kualitas super', rating: 4.8, storeId: '1' },
  { id: '2', name: 'Pupuk NPK Phonska 15-15-15', category: 'Pupuk', price: 320000, stock: 80, sold: 156, status: 'active', image: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=300&fit=crop', description: 'Pupuk majemuk NPK untuk semua jenis tanaman', rating: 4.7, storeId: '1' },
  { id: '3', name: 'Cangkul Baja Anti Karat', category: 'Alat', price: 175000, stock: 45, sold: 89, status: 'active', image: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=300&fit=crop', description: 'Cangkul berkualitas tinggi dengan gagang kayu jati', rating: 4.9, storeId: '2' },
  { id: '4', name: 'Benih Cabai Rawit Dewata', category: 'Benih', price: 45000, stock: 200, sold: 312, status: 'active', image: 'https://images.unsplash.com/photo-1588252303782-cb80119abd6d?w=400&h=300&fit=crop', description: 'Benih cabai rawit dengan tingkat kepedasan tinggi', rating: 4.6, storeId: '2' },
  { id: '5', name: 'Sprayer Elektrik 16L', category: 'Alat', price: 450000, stock: 25, sold: 67, status: 'active', image: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=400&h=300&fit=crop', description: 'Sprayer elektrik dengan kapasitas 16 liter', rating: 4.8, storeId: '3' },
  { id: '6', name: 'Pupuk Organik Cair Bio-G', category: 'Pupuk', price: 125000, stock: 120, sold: 198, status: 'active', image: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=300&fit=crop', description: 'Pupuk organik cair untuk pertumbuhan optimal', rating: 4.5, storeId: '3' },
  { id: '7', name: 'Benih Tomat Cherry', category: 'Benih', price: 35000, stock: 180, sold: 245, status: 'active', image: 'https://images.unsplash.com/photo-1592841200221-a6898f307baa?w=400&h=300&fit=crop', description: 'Benih tomat cherry import berkualitas', rating: 4.7, storeId: '1' },
  { id: '8', name: 'Gunting Stek Profesional', category: 'Alat', price: 95000, stock: 60, sold: 134, status: 'active', image: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=300&fit=crop', description: 'Gunting stek dengan pisau tajam dan ergonomis', rating: 4.9, storeId: '2' },
  { id: '9', name: 'Pestisida Organik Neem Oil', category: 'Pestisida', price: 85000, stock: 90, sold: 167, status: 'active', image: 'https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?w=400&h=300&fit=crop', description: 'Pestisida alami dari minyak mimba', rating: 4.6, storeId: '3' },
  { id: '10', name: 'Benih Jagung Manis Bonanza', category: 'Benih', price: 55000, stock: 0, sold: 289, status: 'out_of_stock', image: 'https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=400&h=300&fit=crop', description: 'Benih jagung manis dengan rasa premium', rating: 4.8, storeId: '1' },
  { id: '11', name: 'Mulsa Plastik Hitam Perak', category: 'Perlengkapan', price: 280000, stock: 35, sold: 78, status: 'active', image: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=300&fit=crop', description: 'Mulsa plastik untuk menekan gulma', rating: 4.4, storeId: '2' },
  { id: '12', name: 'Pupuk Kandang Fermentasi', category: 'Pupuk', price: 45000, stock: 200, sold: 356, status: 'active', image: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=300&fit=crop', description: 'Pupuk kandang yang sudah difermentasi sempurna', rating: 4.7, storeId: '3' },
  { id: '13', name: 'Selang Irigasi Tetes 100m', category: 'Perlengkapan', price: 350000, stock: 40, sold: 56, status: 'active', image: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=400&h=300&fit=crop', description: 'Selang irigasi tetes dengan emitter', rating: 4.5, storeId: '1' },
  { id: '14', name: 'Benih Bayam Hijau', category: 'Benih', price: 25000, stock: 250, sold: 423, status: 'active', image: 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=400&h=300&fit=crop', description: 'Benih bayam hijau cepat panen', rating: 4.6, storeId: '2' },
  { id: '15', name: 'Traktor Mini 2 Roda', category: 'Alat', price: 15500000, stock: 5, sold: 12, status: 'active', image: 'https://images.unsplash.com/photo-1530267981375-f0de937f5f13?w=400&h=300&fit=crop', description: 'Traktor mini untuk lahan kecil dan menengah', rating: 4.9, storeId: '3' },
  { id: '16', name: 'Fungisida Sistemik Antracol', category: 'Pestisida', price: 95000, stock: 75, sold: 145, status: 'active', image: 'https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?w=400&h=300&fit=crop', description: 'Fungisida untuk mengendalikan jamur', rating: 4.5, storeId: '1' },
  { id: '17', name: 'Polybag Hitam 35x35 (100pcs)', category: 'Perlengkapan', price: 65000, stock: 150, sold: 234, status: 'active', image: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=300&fit=crop', description: 'Polybag untuk pembibitan tanaman', rating: 4.3, storeId: '2' },
  { id: '18', name: 'Benih Melon Golden', category: 'Benih', price: 75000, stock: 85, sold: 167, status: 'active', image: 'https://images.unsplash.com/photo-1571575173700-afb9492e6a50?w=400&h=300&fit=crop', description: 'Benih melon golden dengan rasa manis', rating: 4.7, storeId: '3' },
  { id: '19', name: 'Sabit Bergerigi Premium', category: 'Alat', price: 125000, stock: 55, sold: 98, status: 'active', image: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=300&fit=crop', description: 'Sabit dengan mata bergerigi untuk memotong rumput', rating: 4.8, storeId: '1' },
  { id: '20', name: 'Pupuk Daun Gandasil D', category: 'Pupuk', price: 35000, stock: 180, sold: 278, status: 'active', image: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=300&fit=crop', description: 'Pupuk daun untuk fase vegetatif', rating: 4.6, storeId: '2' },
];
